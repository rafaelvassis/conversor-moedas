...
Projeto desenvolvido com foco na prática de fundamentos do React e TypeScript.
...
```bash
git clone https://github.com/rafaelvassis/conversor-moedas.git
cd conversor-moedas
```
...
- Conversão automática durante a digitação
- Seleção de moedas por busca
